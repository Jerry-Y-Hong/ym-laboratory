...
async function loadPortalData() {
  try {
    ...
    translationDictionary = await fetchJson('translation_dictionary.json?v=2.10.12').catch(() => ({}));
    recipesDbLocalized = await fetchJson('yakseon_recipes_localized.json?v=2.10.12').catch(() => ({}));
    traditionalDbLocalized = await fetchJson('yakseon_traditional_encyclopedia_localized.json?v=2.10.12').catch(() => ({}));
