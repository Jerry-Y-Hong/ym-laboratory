...
| 변경 규모 | 예시 | 버전 처리 |
|---|---|---|
| 버그 수정, 번역 수정, 소소한 UI 조정 | 약재 번역 오류 수정 | `2.10.18` → `2.10.19` (패치) |
...
```html
<link rel="stylesheet" href="style.css?v=2.10.18">
<script src="engine.js?v=2.10.18"></script>
<script src="app_core.js?v=2.10.18"></script>
<script src="app_dashboard.js?v=2.10.18"></script>
<script src="app_traditional.js?v=2.10.18"></script>
<script src="app_b2b.js?v=2.10.18"></script>
<script src="app_proposal_builder.js?v=2.10.18"></script>
<script src="app_beauty.js?v=2.10.18"></script>
```
